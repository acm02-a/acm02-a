...
`Python` · `FastAPI` · `pandas` · `n8n` · `Supabase` · `SQL` · `SQLite` · `Docker` · `GitHub Actions` · `JavaScript`
...
| [csv-cleaner](https://github.com/acm02-a/csv-cleaner) | CLI instalable con pip que **limpia CSVs sucios** y entrega un reporte auditable de cada cambio (también en JSON, para pipelines). |
